...
> tags 包含案例类型、申请项目类型、本科专业、申请专业、去向院校、个人经历等。可以定义你觉得必要的 tag，优先从 [已有 tag](../tags/) 中选取。

> 我们的 tag 建议：项目类型、专业方向只要是申请了的都写上，院校只写最终去向，个人经历 highlight 一些重要的，其它的可以在正文中提及。

> 国内升学的同学可以选择性忽略该模板中部分内容。

> 我们的模版依旧基本copy自清华大学飞跃手册，在此感谢。
...
!!! note
    ...
    目前本模板内容和呈现形式还在优化中，如果有任何建议可以在[Github讨论区](https://github.com/WentLyu/mathbridge/discussions)提出。本帖子源 `.md` 文件的路径为 `./docs/cases/example.md`。
...
- 申请专业：专业
- 申请方向：（假如有的话，Ph.D有的学校需要具体到攻读方向，例如拓扑学、Machine Learing Theory等。）
- 申请项目：
    ...
    > 如实填写即可，推免硕、博的项目一般即全日制硕士/博士。

- 最终去向：基础数学 @ 复旦大学
- 联系方式：(希望保护个人隐私的话也可以省略：email/vx/homepage, etc)
...
- GRE：300 (V 150 + Q 150)
- 推荐信: 如实填写 （如果你后验地觉得有黑推可以选择性地 po 出来）
